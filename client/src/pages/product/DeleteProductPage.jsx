  ...
  const handleDeleteProductCategory = async () => {
    ...
    try {
      const res = await axios.delete(
        `http://localhost:8080/api/v1/admin//deleteProductCategory/${id}`,
        {
          headers: {
      ...
      setTimeout(() => navigate("/admin/productCategory"), 500);
    } catch (error) {
      ...
      const errorMessage = error.response?.data?.message || "Lỗi khi xoá danh mục sản phẩm!";
